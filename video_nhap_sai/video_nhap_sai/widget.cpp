    ...
    ui(new Ui::Widget)
{
    ...
    QString file_url;
    file_url = "/home/pi/Desktop/ADELA/video_gui_deThang/Video_coDinh/fileNhapSai.wmv";
...
void Widget::tat_video_mo_tu()
{
    process_tat_video_qc.execute("sudo pkill video_mo_tu");
}
