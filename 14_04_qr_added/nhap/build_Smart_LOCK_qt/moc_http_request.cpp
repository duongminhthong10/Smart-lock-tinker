...
#include "../smart_lock_qt/http_request.h"
...
QT_MOC_LITERAL(1, 12, 8), // "callLock"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 7), // "TimeOut"
QT_MOC_LITERAL(4, 30, 12), // "httpFinished"
QT_MOC_LITERAL(5, 43, 13), // "httpReadyRead"
QT_MOC_LITERAL(6, 57, 4), // "lock"
QT_MOC_LITERAL(7, 62, 10) // "onWaitLock"

    },
    "HttpRequest\0callLock\0\0TimeOut\0"
    "httpFinished\0httpReadyRead\0lock\0"
    "onWaitLock"
};
...
void HttpRequest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HttpRequest::callLock)) {
                *result = 0;
                return;
            }
        }
